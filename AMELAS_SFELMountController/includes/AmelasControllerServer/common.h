...
enum class AmelasServerCommand : zmqutils::common::CommandType
{
    ...
    REQ_DO_SYNC_MANUAL             = 41,
    REQ_DO_SYNC_NTP                = 42,
    REQ_EN_EXT_PPS                 = 43,
    REQ_EN_TRACK_ADJ               = 44,
    REQ_EN_MOUNT_POWER             = 45,
    REQ_SET_IDLE_POS               = 46,
    REQ_GET_IDLE_POS               = 47,
    REQ_SET_PARK_POS               = 48,
    REQ_GET_PARK_POS               = 49,
    REQ_SET_CALIBRATION_POS        = 50,
    REQ_GET_CALIBRATION_POS        = 51,
    REQ_SET_IDLE_POS_HERE          = 52,
    REQ_SET_PARK_POS_HERE          = 53,
    REQ_SET_CALIBRATION_POS_HERE   = 54,
    REQ_SET_WAIT_ALT               = 55,
    REQ_GET_WAIT_ALT               = 56,
    REQ_SET_HOMING_OFFSETS         = 57,
    REQ_GET_HOMING_OFFSETS         = 58,
    REQ_EN_MOUNT_MODEL             = 59,
    REQ_SET_MOUNT_MODEL_COEFS      = 60,
    REQ_GET_MOUNT_MODEL_COEFS      = 61,
    REQ_SET_LOCATION               = 62,
    REQ_GET_LOCATION               = 63,
    REQ_SET_METEO_DATA             = 64,
    REQ_GET_METEO_DATA             = 65,
    REQ_SET_SLEW_SPEED             = 66,
    REQ_GET_SLEW_SPEED             = 67,
    REQ_GET_MOTION_MODE            = 68,
    REQ_GET_MOTION_STATE           = 69,
    REQ_DO_START_MOTION            = 70,
    REQ_DO_PAUSE_MOTION            = 71,
    REQ_DO_STOP_MOTION             = 72,
    REQ_SET_TRACK_POS_OFFSET       = 73,
    REQ_GET_TRACK_POS_OFFSET       = 74,
    REQ_SET_TRACK_TIME_BIAS        = 75,
    REQ_GET_TRACK_TIME_BIAS        = 76,
    REQ_SET_ABS_ALTAZ_MOTION       = 77,
    REQ_SET_REL_ALTAZ_MOTION       = 78,
    REQ_SET_CON_ALTAZ_MOTION       = 79,
    REQ_SET_HOMING_MOTION          = 80,
    REQ_SET_IDLE_MOTION            = 81,
    REQ_SET_PARK_MOTION            = 82,
    REQ_SET_CALIBRATION_MOTION     = 83,
    REQ_SET_CPF_MOTION             = 84,
    REQ_SET_STAR_MOTION            = 85,
    REQ_DO_CONNECT_PLC             = 86,
    REQ_DO_DISCONNECT_PLC          = 87,
